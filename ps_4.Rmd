...
# Question 1: Create separate variable to store value of number of Republican supporters
...
# Question 3: turn the top timestamp character string into the date/time format
rep_timestamp <- x %>%
